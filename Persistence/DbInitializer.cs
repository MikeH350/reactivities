...
{
    //When we want to make a db request that could take a bit of time,
    //We want to use asyncronous code to await the retrieval.
    //We are effectively returning void (nothing), 
    public static async Task SeedData(AppDbContext context)
    {
        ...
        //tracking the fact that we've updated the data in memory
